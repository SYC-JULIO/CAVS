...
export const QUESTIONS: QuestionConfig[] = [
  ...
  { id: 10, text: '個案過去暴力行為或危機介入的嚴重程度？', weights: { low: [1,0,1,2], medium: [2,1,3,2], high: [3,2,6,4] } },
  { id: 11, text: '夜間照顧與守夜的需求程度？', weights: { low: [1,0,0,1], medium: [3,0,1,2], high: [5,0,2,4] } },
  { id: 12, text: '失蹤、走失經驗危險程度？', weights: { low: [1,1,0,1], medium: [2,1,2,1], high: [4,2,4,3] } },
  ...
  { id: 28, text: '是否曾涉及法律相關事件（如監護、訴訟等）？', weights: { low: [0,1,0,1], medium: [1,2,1,2], high: [2,4,3,2] } },
  { id: 29, text: '是否具宗教或文化照護特別需求？', weights: { low: [0,0,0,0], medium: [1,1,1,1], high: [2,2,2,2] } },
  { id: 30, text: '個案是否有對照顧人員提出不實指控紀錄？', weights: { low: [1,1,2,1], medium: [2,2,3,2], high: [3,3,5,3] } },
];
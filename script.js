...
const API_URL = "https://cavs-k8j0.onrender.com/api/assess"; 

// 評分矩陣 (請確保這裡有完整的 Q1-Q30 數據，這裡僅為範例 Q1)
const SCORE_MATRIX = {
    "q1": { "low": [1, 0, 2, 1], "medium": [3, 1, 3, 2], "high": [5, 3, 5, 4] },
    "q2": {"low":[1,0,0,0], 中度:[3,1,1,1], 高度:[6,1,2,2]}
    "q3": {"low":[2,0,0,1], 中度:[4,1,2,2], 高度:[7,2,4,3]}
"q4": {"low":[2,0,1,0], 中度:[4,1,4,2], 高度:[5,2,6,3]}
"q5": {"low":[0,1,0,0], 中度:[1,3,2,1], 高度:[2,5,3,2]}
"q6": {"low":[1,0,0,1], 中度:[2,0,1,3], 高度:[4,1,2,5]}
"q7": {"low":[1,0,0,1], 中度:[3,1,2,2], 高度:[5,1,4,4]}
"q8": {"low":[0,1,0,1], 中度:[1,2,1,2], 高度:[2,4,2,3]}
"q9": {"low":[0,0,0,0], 中度:[2,0,1,1], 高度:[4,2,5,3]}
"q10": {"low":[0,0,0,0], 中度:[2,1,3,2], 高度:[3,2,6,4]}
"q11": {"low":[0,0,0,0], 中度:[3,0,1,2], 高度:[5,0,2,4]}
"q12": {"low":[0,0,0,0], 中度:[2,1,2,1], 高度:[4,2,4,3]}
"q13": {"low":[0,0,0,0], 中度:[1,0,0,1], 高度:[3,1,1,2]}
"q14": {"low":[0,0,0,0], 中度:[3,1,4,2], 高度:[5,2,6,3]}
"q15": {"low":[0,0,0,0], 中度:[4,0,0,2], 高度:[6,0,1,4]}
"q16": {"low":[0,0,0,0], 中度:[1,2,1,2], 高度:[2,4,2,3]}
"q17": {"low":[0,0,0,0], 中度:[2,1,1,1], 高度:[3,1,2,2]}
"q18": {"low":[0,0,0,0], 中度:[1,2,1,2], 高度:[2,3,2,3]}
"q19": {"low":[0,0,0,0], 中度:[1,2,2,1], 高度:[2,4,3,2]}
"q20": {"low":[0,0,0,0], 中度:[2,0,2,1], 高度:[3,1,5,3]}
"q21": {"low":[0,0,0,0], 中度:[1,3,1,2], 高度:[1,5,2,3]}
"q22": {"low":[0,0,0,0], 中度:[1,2,2,1], 高度:[2,4,3,2]}
"q23": {"low":[0,0,0,1], 中度:[1,0,1,2], 高度:[2,0,2,3]}
"q24": {"low":[0,0,0,0], 中度:[2,0,0,2], 高度:[3,0,1,3]}
"q25": {"low":[0,0,0,0], 中度:[1,2,1,1], 高度:[2,4,2,3]}
"q26": {"low":[0,0,0,0], 中度:[1,1,1,1], 高度:[2,2,1,2]}
"q27": {"low":[0,0,0,1], 中度:[1,1,1,2], 高度:[2,3,2,3]}
"q28": {"low":[0,0,0,0], 中度:[1,2,1,2], 高度:[2,4,3,2]}
"q29": {"low":[0,0,0,0], 中度:[1,1,1,1], 高度:[2,2,2,2]}
"q30": {"low":[0,0,0,0], 中度:[2,2,3,2], 高度:[3,3,5,3]}
    // ... 請記得補上 Q2 到 Q30 的數據 ...
};
